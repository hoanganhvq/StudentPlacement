...
class CareerInputChat(BaseModel):
    ...
    next_question: str = Field(description="Câu hỏi tự nhiên để thu thập các thông tin còn thiếu")
    is_off_topic: bool = Field(default=False)
    analysis_feedback: str = Field(default="")
    is_complete: bool = Field(description="True nếu đã thu thập đủ 11 trường dữ liệu")
